...
2. [JNI学习(一)：在JAVA中调用C++/C代码 JNI](https://blog.csdn.net/Applying/article/details/81572167)
3. [JNI学习(二)：Java 与 C++ 之间传递String，自定义类，自定义类的数组](https://blog.csdn.net/Applying/article/details/82393212)
...
1. [使用断点（DeBug）](https://blog.csdn.net/Applying/article/details/82925061)
2. [设置Maven路径 对当前项目生效 && 永久生效](https://blog.csdn.net/Applying/article/details/104487984)
3. [常用快捷键总结 【持续更新】](https://blog.csdn.net/Applying/article/details/106065669)
